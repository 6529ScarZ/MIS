...
CREATE TABLE `billdisp` (
  ...
  `charg_amount` int(7) DEFAULT NULL,
  `claim_amount` int(7) DEFAULT NULL,
  `paid_amount` int(7) DEFAULT NULL,
  `other_amount` int(7) DEFAULT NULL,
...
CREATE TABLE `billdisp_item` (
  ...
  `Chargeamount` int(6) DEFAULT NULL,
  `ReimbPrice` decimal(6,2) DEFAULT NULL,
  `ReimbAmount` int(6) DEFAULT NULL,
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', 'ฐานปนพงศ์', 'ดีอุดมจันทร์', 'scarz', 'a182e991eb5396de1e18f430dbc49a37', 'ac10ec1ace51b2d973cd87973a98d3ab', '0', null, '2016-10-11 16:10:43', '1476177883');
INSERT INTO `user` VALUES ('2', 'ขัตติยา', 'วัฒนา', 'ae', 'b6bb43df4525b928a105fb5741bddbea', '81dc9bdb52d04dc20036dbd8313ed055', '1', null, '2016-10-10 16:10:14', '1476091574');
INSERT INTO `user` VALUES ('3', 'สมิง', 'ศรีบุตรตา', 'toy', '10016b6ed5a5b09be08133fa2d282636', '81dc9bdb52d04dc20036dbd8313ed055', '1', null, null, null);
